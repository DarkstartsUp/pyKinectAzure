...
bodyTrackingModulePath = 'C:\\Program Files\\Azure Kinect SDK v1.4.1\\sdk\\windows-desktop\\amd64\\release\\bin\\k4abt.dll'
...
if __name__ == "__main__":
	...
	while True:
		...
		if depth_image_handle:
			...
			# Print the locations of key-point
			print('====================== locations ======================')
			bodies = pyK4A.body_tracker.bodiesNow
			for body in bodies:
				pyK4A.body_tracker.printBodyPosition(body)
				x = body.skeleton.joints[_k4abt.K4ABT_JOINT_EYE_RIGHT].position.v[0]
				y = body.skeleton.joints[_k4abt.K4ABT_JOINT_EYE_RIGHT].position.v[1]
				z = body.skeleton.joints[_k4abt.K4ABT_JOINT_EYE_RIGHT].position.v[2]
				print('Right eye location: x: {} mm, y: {} mm, z: {} mm'.format(x, y, z))
